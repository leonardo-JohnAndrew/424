                    ...
                    <form action="add.php" method="get">
                        <div class="input-group">
                            ...
                            <H6  style="margin-right:350px ;">Classification</H6>
                                <input type="text" placeholder="Laboratory"name = "class" class="input-field" >
                            </div>
                            <div>
                            ...
                            <div>
                            <H6  style="margin-right:350px ;">PC Unit No</H6>
                                <input type="text" placeholder="PC Unit no." name = "pc_unit"class="input-field">
                            </div>
                            <H6 style="margin-right:350px ;">Problem</H6>
                                <input type="text" placeholder="PC Unit no." name = "prob" id = "input">
