         ...
         ?>
           ...
           <td><input type="text" name="no_<?= $rows['No'] ?>" value="<?php  echo $rows['No'] ?>" size="10px" readonly></td>
            <td><input type="text" name="class_<?= $rows['No'] ?>" value="<?php  echo $rows['classification'] ?>" size="10px" readonly></td>
             ...
             <td><input type="text" name="code_<?= $rows['No']?>" value="<?php echo $rows['unit_code'] ?>" size="10px"></td>
             <td><input type="text" name="received_<?= $rows['No'] ?>" value="<?php echo date('Y-m-d') ?>" size="10px"></td>
             <td><input type="text" name="return_<?= $rows['No'] ?>" value="<?php ?>" size="10px"></td>
